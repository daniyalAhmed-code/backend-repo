          ...
          <AltControls
            ...
            main={(
              <>
                ...
                {/* A hidden control to tackle big step without alt key */}
                <ControlButton
                  hidden={true}
          ...
          <AltControls
            ...
            main={(
              <>
                ...
                {/* A hidden control to handle big step without alt key */}
                <ControlButton
                  hidden={true}
...
export const ControlButton: FC<ButtonProps & {disabled?: boolean}> = ({ children, ...props }) => {
  return (
    <Button
      {...props}
      type="text"
      style={{ width: 36, height: 36, padding: 0, visibility: props.hidden ? 'hidden' : 'unset' }}
    >
      {children}
    </Button>
  );
