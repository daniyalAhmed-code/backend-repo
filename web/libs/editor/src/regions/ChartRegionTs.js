...
import { ChartModel } from '../tags/object/Chart';
import { guidGenerator } from '../core/Helpers';
import Registry from '../core/Registry';
import { AreaMixin } from '../mixins/AreaMixin';
import { AnnotationMixin } from '../mixins/AnnotationMixin';

const hotkeys = Hotkey('Chart', 'Chart Region Segmentation');

const Model = types
  .model('ChartRegionModel', {
    id: types.optional(types.identifier, guidGenerator),
    pid: types.optional(types.string, guidGenerator),
    type: 'chartregion',
    object: types.late(() => types.reference(ChartModel)),
  ...
  .actions(self => ({
    ...
    serialize() {
      ...
      const res = {
        value: {
          start: self.start, //format(self.start),
          end: self.end, //format(self.end),
...
Registry.addTag('chartregion', ChartRegionModel, () => {});
Registry.addRegionType(ChartRegionModel, 'chart');

export { ChartRegionModel };
