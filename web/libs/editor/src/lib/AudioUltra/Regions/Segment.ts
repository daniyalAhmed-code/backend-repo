...
export interface SegmentOptions {
  ...
  external?: boolean;
  setSegmentSelected?: (region: Segment) => void;
  setSegmentUnSelected?: (region: Segment) => void;
}
...
export class Segment extends Events<SegmentEvents> {
  ...
  setSegmentSelected = (region: Segment) => {};
  setSegmentUnSelected = (region: Segment) => {};
  ...
  constructor(
    ...
    if(options.setSegmentSelected) this.setSegmentSelected = options.setSegmentSelected;
    if(options.setSegmentUnSelected) this.setSegmentUnSelected = options.setSegmentUnSelected;
  ...
  handleSelected = (selected?: boolean) => {
    ...
    if(this.selected)this.setSegmentSelected(this);
    else this.setSegmentUnSelected(this);
    this.invoke('update', [this]);
    this.waveform.invoke('regionUpdated', [this]);
  };
  ...
  convertToRegion(labels: string[], render = false) {
    if (!this.updateable) return;
    this.setSegmentUnSelected(this);
