...
export const DataStore = (
  ...
  const model = types
    ...
    .actions((self) => ({
      ...
      fetch: flow(function* ({ id, query, pageNumber = null, reload = false, interaction, pageSize, callForAttnTasks = localStorage.getItem('show-attn-tasks')?.toLowerCase() == 'true' } = {}) {
        ...
        const data = yield root.apiCall( callForAttnTasks ? "needAttTasks" : apiMethod, params, {}, { allowToCancel: root.SDK.type === 'DE' });
