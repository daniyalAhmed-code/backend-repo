...
const DEFAULT_TOOLBAR = "actions columns filters ordering label-button loading-possum error-box | refresh attn-task-toggle stats-button import-button export-button view-toggle";
...
export class DataManager {
  ...
  initLSF(element) {
    ...
    this.lsf = new LSFWrapper(this, element, {
      ...
      adminsList: this.store.adminsList,
    });
  }
