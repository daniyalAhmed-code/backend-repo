...
export const DataView = injector(
  ({
    ...
    const loadMore = useCallback(async () => {
      ...
      await dataStore.fetch({ interaction: "scroll", callForAttnTasks: shouldShowAttnTasks });
      return Promise.resolve();
    }, [dataStore, shouldShowAttnTasks]);
    ...
    const renderContent = useCallback(
      ...
      [hasData, isLabeling, isLoading, total, datasetStatusID, shouldShowAttnTasks],
    );
    ...
    return (
      ...
      >
        {/* <Switch checkedChildren={"Attention Needed Tasks"} unCheckedChildren={"All Tasks"} checked={shouldShowAttnTasks} onChange={() => {
